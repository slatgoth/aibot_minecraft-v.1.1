...
## Что нового в v1.2
- Автоподключение при разрыве (ECONNRESET) с настраиваемыми параметрами.
- Улучшены ошибки запуска в панели (видно причину).
- Кнопка "Запустить всё" для ViaProxy + бот.
